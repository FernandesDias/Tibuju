...
class Cadastro extends CI_Controller{
    ...
    public function adicionar(){
        ...
        $this->form_validation->set_rules('cpf','required|min_length[14]');
    ...
    public function enviar_email_confirmacao($dados){
        $mensagem = $this->load->view('email/confirmar_cadastro.php',$dados,TRUE);
        $this->load->library('email');
        $this->email("loja@gmail.com.br","Loja Do Junior");
        $this->email->to($dados['email']);
        $this->email->subject('Loja do JUnior - confirmacao de email');
...
public function login(){
    ...
    $this->form_validation->set_rule('senha','Senha','required|min_length[5]');
    if($this->form_validation->run()==FALSE){
        $this->form_login();
    }else{
